...
from quocs_pyqtinterface.logic.OptimalAlgorithmDictionaries.StoppingCriteriaNelderMeadDictionary import \
    StoppingCriteriaNelderMeadDictionary
from quocs_pyqtinterface.gui.uiclasses.StoppingCriteriaNMUI import Ui_Form
