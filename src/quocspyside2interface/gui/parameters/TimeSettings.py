...
from quocspyside2interface.logic.parameters.TimeDictionary import TimeDictionary

from qtpy import uic
import os


TimeDefinitionWidget = uic.loadUiType(os.path.join(os.path.dirname(__file__), "TimeDefinition.ui"))[0]


class TimeSettings(QtWidgets.QWidget, TimeDefinitionWidget):
    def __init__(self, control_index, update_name_time_signal, update_time_combo_box_pulse, 
                 loaded_dictionary=None, parent=None,):
