...
GetFromFileFunctionWidget = uic.loadUiType(os.path.join(os.path.dirname(__file__), "GetFromFileFunction.ui"))[0]


class GetFromFileFunction(QtWidgets.QWidget, GetFromFileFunctionWidget):
