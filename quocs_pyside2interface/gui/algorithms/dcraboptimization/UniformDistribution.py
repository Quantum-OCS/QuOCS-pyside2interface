...
from quocs_pyside2interface.logic.OptimalAlgorithmDictionaries.UniformDistributionDictionary \
    import UniformDistributionDictionary
from quocs_pyside2interface.gui.uiclasses.UniformDistributionUI import Ui_Form
