...
from quocs_pyside2interface.gui.settings.AllInOneCommForm import AllInOneCommForm
from quocs_pyside2interface.gui.settings.FilesUpdateForm import FilesUpdateForm
from quocs_pyside2interface.gui.settings.LocalCommForm import LocalCommForm
from quocs_pyside2interface.gui.settings.PythonClassForm import PythonClassForm
from quocs_pyside2interface.gui.settings.RemoteCommForm import RemoteCommForm
from quocs_pyside2interface.gui.uiclasses.CommFomSettingsUI import Ui_Form
