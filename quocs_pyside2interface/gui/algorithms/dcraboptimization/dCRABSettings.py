...
from quocs_pyside2interface.logic.OptimalAlgorithmDictionaries.dCRABSettingsDictionary import dCRABSettingsDictionary
from quocs_pyside2interface.gui.uiclasses.dCRABSettingsUI import Ui_Form
