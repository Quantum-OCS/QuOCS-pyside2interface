...
from quocs_pyside2interface.logic.OptimalAlgorithmDictionaries.StoppingCriteriaNelderMeadDictionary import \
    StoppingCriteriaNelderMeadDictionary
from quocs_pyside2interface.gui.uiclasses.StoppingCriteriaNMUI import Ui_Form


class StoppingCriteriaNM(QtWidgets.QWidget, Ui_Form):
