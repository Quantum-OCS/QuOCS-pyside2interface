...
from quocs_pyside2interface.gui.algorithms.pureparametersoptimization.PureControlsSettings import PureControlsSettings
from quocs_pyside2interface.gui.freegradients.GeneralSettingsNM import GeneralSettingsNM
from quocs_pyside2interface.gui.settings.CommunicationFoMSettings import CommFom
from quocs_pyside2interface.logic.OptimalAlgorithmDictionaries.PureParametrizationGlobalDictionary import PureParametrizationGlobalDictionary
from quocs_pyside2interface.gui.uiclasses.PureParametersOptimizationSettingsUI import Ui_Dialog


class DirectSearchSettingsDialog(QtWidgets.QDialog, Ui_Dialog):
    """Dialogue for dCRAB"""
    ...
    def __init__(self, parent=None, load_full_dictionary_signal=None, loaded_dictionary=None):
        ...
        general_settings_index = self.general_pure_tab.addTab(GeneralSettingsNM(loaded_dictionary=general_settings_nm), "Direct Search Method Settings")
        # Controls
        controls_settings_index = self.general_pure_tab.addTab(PureControlsSettings(loaded_dictionary=controls_settings), "Controls Settings")
        # Communication and Figure of merit calculation
        comm_fom_settings_index = self.general_pure_tab.addTab(CommFom(loaded_dictionary=comm_fom_settings), "Communication and FoM Settings")
    ...
    def save_opti_dictionary(self):
        ...
        from quocs_pyside2interface.logic.utilities.writejsonfile import writejsonfile
