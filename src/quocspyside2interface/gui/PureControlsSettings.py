...
from quocspyside2interface.logic.parameters.ParameterDictionary import ParameterDictionary


PureParametersOptimizationControlsWidget = \
    uic.loadUiType(os.path.join(os.path.dirname(__file__), "PureParametersOptimizationControls.ui"))[0]


class PureControlsSettings(QtWidgets.QWidget, PureParametersOptimizationControlsWidget):

    def __init__(self, loaded_dictionary: dict = None, parent=None):
