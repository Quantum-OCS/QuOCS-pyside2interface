...
LocalCommunicationForm = uic.loadUiType(os.path.join(os.path.dirname(__file__), "LocalCommunication.ui"))[0]


class LocalCommForm(QtWidgets.QWidget, LocalCommunicationForm):
