...
from quocs_pyqtinterface.logic.OptimalAlgorithmDictionaries.TimeDictionary import TimeDictionary
from quocs_pyqtinterface.gui.uiclasses.TimeDefinitionUI import Ui_Form
