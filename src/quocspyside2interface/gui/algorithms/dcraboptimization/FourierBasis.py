...
from quocspyside2interface.logic.OptimalAlgorithmDictionaries.FourierBasisDictionary import FourierBasisDictionary
from quocspyside2interface.gui.uiclasses.FourierBasisUI import Ui_Form
