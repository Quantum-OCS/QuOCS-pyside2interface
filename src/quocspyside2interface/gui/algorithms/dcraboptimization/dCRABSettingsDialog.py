...
from quocspyside2interface.gui.algorithms.GeneralOptimizationDialog import GeneralOptimizationDialog
from quocspyside2interface.gui.algorithms.dcraboptimization.ControlSettings import ControlsSettings
from quocspyside2interface.gui.algorithms.dcraboptimization.dCRABSettings import dCRABSettings
from quocspyside2interface.gui.freegradients.GeneralSettingsNM import GeneralSettingsNM
from quocspyside2interface.logic.OptimalAlgorithmDictionaries.dCRABGlobalDictionary import dCRABGlobalDictionary
from quocspyside2interface.gui.uiclasses.dCRABOptimizationDialogUI import Ui_Dialog
