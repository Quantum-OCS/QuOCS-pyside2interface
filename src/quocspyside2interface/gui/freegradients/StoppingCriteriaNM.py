...
from quocspyside2interface.logic.OptimalAlgorithmDictionaries.StoppingCriteriaNelderMeadDictionary import \
    StoppingCriteriaNelderMeadDictionary
from quocspyside2interface.gui.uiclasses.StoppingCriteriaNMUI import Ui_Form
