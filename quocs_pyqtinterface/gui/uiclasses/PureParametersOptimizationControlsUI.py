...
################################################################################
## Form generated from reading UI file 'PureParametersOptimizationControls.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.parameters_number_spinbox = QSpinBox(Form)
        ...
        self.update_parameters_number_button = QPushButton(Form)
        self.update_parameters_number_button.setObjectName(u"update_parameters_number_button")

        self.horizontalLayout_16.addWidget(self.update_parameters_number_button)
        ...
        self.parameter_number_selected_spinbox = QSpinBox(Form)
        ...
        self.parameter_name_edit_line = QLineEdit(Form)
        ...
        self.remove_parameter_button = QPushButton(Form)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1336, 148))
        ...
        self.apply_all_parameters_button = QPushButton(Form)
        ...
        self.verticalSpacer = QSpacerItem(20, 558, QSizePolicy.Minimum, QSizePolicy.Expanding)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Number of parameters", None))
        self.update_parameters_number_button.setText(QCoreApplication.translate("Form", u"Update parameters number", None))
        self.label_16.setText(QCoreApplication.translate("Form", u"Select Parameter number", None))
        self.label_4.setText(QCoreApplication.translate("Form", u"Parameter Selected", None))
        self.label_15.setText(QCoreApplication.translate("Form", u"Parameter Name", None))
        self.remove_parameter_button.setText(QCoreApplication.translate("Form", u"Remove parameter", None))
        self.label_10.setText(QCoreApplication.translate("Form", u"Initial Value", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"Lower Limit", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"Upper Limit", None))
        self.label_9.setText(QCoreApplication.translate("Form", u"Variation", None))
        self.apply_all_parameters_button.setText(QCoreApplication.translate("Form", u"Apply to all parameters", None))
    # retranslateUi
