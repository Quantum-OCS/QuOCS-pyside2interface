...
# Form implementation generated from reading ui file '/home/mrossign/QuOCS/QuOCS-pyqtinterface/quocs_pyqtinterface/gui/uifiles/PureParametersOptimizationControls.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.parameters_number_spinbox = QtWidgets.QSpinBox(Form)
        ...
        self.update_parameters_number_button = QtWidgets.QPushButton(Form)
        self.update_parameters_number_button.setObjectName("update_parameters_number_button")
        ...
        self.parameter_number_selected_spinbox = QtWidgets.QSpinBox(Form)
        ...
        self.parameter_name_edit_line = QtWidgets.QLineEdit(Form)
        ...
        self.remove_parameter_button = QtWidgets.QPushButton(Form)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1336, 148))
        ...
        self.apply_all_parameters_button = QtWidgets.QPushButton(Form)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(20, 558, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Number of parameters"))
        self.update_parameters_number_button.setText(_translate("Form", "Update parameters number"))
        self.label_16.setText(_translate("Form", "Select Parameter number"))
        self.label_4.setText(_translate("Form", "Parameter Selected"))
        self.label_15.setText(_translate("Form", "Parameter Name"))
        self.remove_parameter_button.setText(_translate("Form", "Remove parameter"))
        self.label_10.setText(_translate("Form", "Initial Value"))
        self.label_3.setText(_translate("Form", "Lower Limit"))
        self.label_2.setText(_translate("Form", "Upper Limit"))
        self.label_9.setText(_translate("Form", "Variation"))
        self.apply_all_parameters_button.setText(_translate("Form", "Apply to all parameters"))
