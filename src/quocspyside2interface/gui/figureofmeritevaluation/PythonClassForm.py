...
from quocspyside2interface.gui.figureofmeritevaluation.NewPythonArgument import NewPythonArgument
from quocspyside2interface.logic.OptimalAlgorithmDictionaries.PythonClassFoMDictionary import PythonClassFomDictionary

from qtpy import uic
import os


PythonEvaluationWidget = uic.loadUiType(os.path.join(os.path.dirname(__file__), "PythonEvaluation.ui"))[0]


class PythonClassForm(QtWidgets.QWidget, PythonEvaluationWidget):
