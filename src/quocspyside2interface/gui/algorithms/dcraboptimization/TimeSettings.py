...
from quocspyside2interface.logic.OptimalAlgorithmDictionaries.TimeDictionary import TimeDictionary
from quocspyside2interface.gui.uiclasses.TimeDefinitionUI import Ui_Form
