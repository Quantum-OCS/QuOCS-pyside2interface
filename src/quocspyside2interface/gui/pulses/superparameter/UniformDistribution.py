...
from quocspyside2interface.logic.pulses.superparameter.UniformDistributionDictionary \
    import UniformDistributionDictionary


UniformDistributionWidget = uic.loadUiType(os.path.join(os.path.dirname(__file__), "UniformDistribution.ui"))[0]


class UniformDistribution(QtWidgets.QWidget, UniformDistributionWidget):
    def __init__(self, loaded_dictionary: dict = None, parent=None):
        super().__init__(parent=parent)
        self.setupUi(self)
        # Dictionary for the uniform distribution
