...
from quocspyside2interface.logic.optimalalgorithms.dCRABSettingsDictionary import dCRABSettingsDictionary


dCRABSettingsNMWidget = uic.loadUiType(os.path.join(os.path.dirname(__file__), "dCRABSettings.ui"))[0]


class dCRABSettings(QtWidgets.QWidget, dCRABSettingsNMWidget):
