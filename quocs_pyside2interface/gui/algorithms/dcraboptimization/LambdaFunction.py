...
from quocs_pyside2interface.logic.OptimalAlgorithmDictionaries.LambdaFunctionDictionary import LambdaFunctionDictionary
from quocs_pyside2interface.gui.uiclasses.LambdaFunctionUI import Ui_Form
