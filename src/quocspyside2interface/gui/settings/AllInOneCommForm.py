...
from quocspyside2interface.logic.OptimalAlgorithmDictionaries.AllInOneCommunicationDictionary import \
    AllInOneCommunicationDictionary
from qtpy import QtWidgets
from quocspyside2interface.gui.uiclasses.AllInOneCommunicationUI import Ui_Form
