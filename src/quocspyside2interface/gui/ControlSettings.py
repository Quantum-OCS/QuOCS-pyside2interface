...
from quocspyside2interface.gui.parameters.ParameterSettings import ParameterSettings
from quocspyside2interface.gui.pulses.PulsesSettings import PulseSettings
from quocspyside2interface.gui.parameters.TimeSettings import TimeSettings

from quocspyside2interface.logic.ControlDictionary import ControlsDictionary


ControlsTabWidget = uic.loadUiType(os.path.join(os.path.dirname(__file__), "ControlsTab.ui"))[0]


class ControlsSettings(QtWidgets.QWidget, ControlsTabWidget):
    # Signals
    ...
    def initialize_time_widget(self, time_dictionary=None):
        ...
        control_widget = TimeSettings(index_name, self.update_tab_name_signal, self.update_time_combo_box_pulse,
                                      loaded_dictionary=time_dictionary, parent=self)
