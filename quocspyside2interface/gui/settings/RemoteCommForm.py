...
from quocspyside2interface.logic.ComunicationSettingsDictionaries.RemoteCommunicationDictionary \
    import RemoteCommunicationDictionary
from quocspyside2interface.gui.uiclasses.RemoteConnectionUI import Ui_Form
