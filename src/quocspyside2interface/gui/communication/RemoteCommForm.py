...
from quocspyside2interface.logic.communication.RemoteCommunicationDictionary \
    import RemoteCommunicationDictionary

RemoteConnectionForm = uic.loadUiType(os.path.join(os.path.dirname(__file__), "RemoteConnection.ui"))[0]


class RemoteCommForm(QtWidgets.QWidget, RemoteConnectionForm):
