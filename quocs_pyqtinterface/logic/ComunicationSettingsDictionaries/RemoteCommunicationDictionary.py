...
class RemoteCommunicationDictionary(SettingsDictionary):

    def __init__(self, loaded_dictionary=None):
        self.communication_type = "RemoteCommunication"
    ...
    def get_summary_list(self):
        summary_list = ["Remote Communication"]
        for element in self.__dict__:
            if element == "password":
                pass
            else:
                summary_list.append(element+" : "+self.__dict__[element])
        return summary_list
