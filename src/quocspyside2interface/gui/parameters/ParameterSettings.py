...
ParameterDefinitionWidget = uic.loadUiType(os.path.join(os.path.dirname(__file__), "ParameterDefinition.ui"))[0]


class ParameterSettings(QtWidgets.QWidget, ParameterDefinitionWidget):
