...
from quocspyside2interface.gui.communication.AllInOneCommForm import AllInOneCommForm
from quocspyside2interface.gui.figureofmeritevaluation.FilesUpdateForm import FilesUpdateForm
from quocspyside2interface.gui.communication.LocalCommForm import LocalCommForm
from quocspyside2interface.gui.figureofmeritevaluation.PythonClassForm import PythonClassForm
from quocspyside2interface.gui.communication.RemoteCommForm import RemoteCommForm

from qtpy import uic
import os

CommunicationFomForm = uic.loadUiType(os.path.join(os.path.dirname(__file__), "CommFomSettings.ui"))[0]


class CommFom(QtWidgets.QWidget, CommunicationFomForm):
