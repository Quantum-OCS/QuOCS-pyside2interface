...
from quocspyside2interface.gui.stoppingcriteria.StoppingCriteriaNM import StoppingCriteriaNM
from quocspyside2interface.logic.freegradientmethods.NelderMeadDictionary import NelderMeadDictionary

from qtpy import uic
import os


GeneralSettingsNMWidget = uic.loadUiType(os.path.join(os.path.dirname(__file__), "GeneralSettingsNM.ui"))[0]


class GeneralSettingsNM(QtWidgets.QWidget, GeneralSettingsNMWidget):
