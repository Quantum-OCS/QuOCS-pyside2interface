...
from quocs_pyside2interface.logic.OptimalAlgorithmDictionaries.NewPythonArgumentDictionary import NewPythonArgumentDictionary
from quocs_pyside2interface.gui.uiclasses.NewPythonArgumentUI import Ui_Form
