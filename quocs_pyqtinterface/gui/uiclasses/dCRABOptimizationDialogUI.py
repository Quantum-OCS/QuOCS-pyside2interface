...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.general_optimization_tab = QtWidgets.QTabWidget(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.general_optimization_tab.sizePolicy().hasHeightForWidth())
        self.general_optimization_tab.setSizePolicy(sizePolicy)
        self.general_optimization_tab.setObjectName("general_dcrab_tab")
        self.verticalLayout.addWidget(self.general_optimization_tab)
