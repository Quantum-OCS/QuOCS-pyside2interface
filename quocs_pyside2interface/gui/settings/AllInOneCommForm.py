...
from quocs_pyside2interface.logic.OptimalAlgorithmDictionaries.AllInOneCommunicationDictionary import \
    AllInOneCommunicationDictionary
from qtpy import QtWidgets
from quocs_pyside2interface.gui.uiclasses.AllInOneCommunicationUI import Ui_Form
